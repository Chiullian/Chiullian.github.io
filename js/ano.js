...
if (pathName === '/') {
  $(document).ready(function(){
      if ( $("#bber-talk").length > 0 ) {
        var jsonUrl = ''
        jsonUrl = "https://636c-clian-7g5m9oo707813d18-1310956618.tcb.qcloud.la/json/bber.json"
        $.getJSON(jsonUrl+"?t="+Date.parse( new Date()),function(res){
          ...
          $.each(res.data, function(i, item){
            ...
            bberHtml += '<li class="item item-'+(i+1)+'">'+'<a href="https://chiullian.cn/bb/" style="color: var(--font-color);/*font-weight: normal;*/">'+newdataTime+'： '+urlToLink(item.content)+'</a></li>'
          });
